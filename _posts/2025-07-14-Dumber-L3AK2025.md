...
Como se menciona en el enunciado, este código es vulnerable a un ataque basado en reducción por la manera en la que se contruye la variable `k`.
...
Por lo que tenemos que construir una retícula (lattice) en la que el vector corto nos proporcione la **correción de error** o directamente el primo `p`,
